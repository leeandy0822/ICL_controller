...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mav_planning_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leeandy/Desktop/ICL_controller/Gazebo_simulation/mav_comm/matlab_msg_gen_ros1/glnxa64/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/leeandy/Desktop/ICL_controller/Gazebo_simulation/mav_comm/matlab_msg_gen_ros1/glnxa64/install/lib;/home/leeandy/MATLAB_2021b/sys/ros1/glnxa64/ros1/lib;/home/leeandy/MATLAB_2021b/toolbox/ros/mlroscpp/custom_messages/lib)
