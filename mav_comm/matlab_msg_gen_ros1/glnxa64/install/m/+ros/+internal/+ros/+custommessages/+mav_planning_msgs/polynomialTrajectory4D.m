function [data, info] = polynomialTrajectory4D
%PolynomialTrajectory4D gives an empty data for mav_planning_msgs/PolynomialTrajectory4D
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'mav_planning_msgs/PolynomialTrajectory4D';
[data.Header, info.Header] = ros.internal.ros.messages.std_msgs.header;
info.Header.MLdataType = 'struct';
[data.Segments, info.Segments] = ros.internal.ros.custommessages.mav_planning_msgs.polynomialSegment4D;
info.Segments.MLdataType = 'struct';
info.Segments.MaxLen = NaN;
info.Segments.MinLen = 0;
data.Segments = data.Segments([],1);
info.MessageType = 'mav_planning_msgs/PolynomialTrajectory4D';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
