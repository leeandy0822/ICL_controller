...
origin_matrix = [1 1 ; -0.325 - CoM 0.325-CoM];
...
x0 = [ Force(1) Force(2) 0.325- CoM -0.325-CoM ];
...
fprintf("Save about: %4.3f percent of energy \n", (Force(1)^1.5 - x(1)^1.5)/Force(1)^1.5*100)
fprintf("Position: %4.3f %4.3f\n", x(3), x(4));
...
global CoM;
weight = 10;
energy_comsumption = (x(1)^1.5 + x(2)^1.5) + weight*sqrt((x(3) - x(4) - 0.65)^2);
