classdef controller
   methods
       function [control, error, mass_est , J_est, icl, W_dot] = geometric_tracking_ctrl(obj, iter, uav_a,multirotor, Xd_enu, b1d, icl, dt, select_force_feedforward, select_moment_feedforward, select_moment_adaptive_w_wo_ICL)
           % f, M
           control = zeros(4, 1);
...
%            kW = diag([20; 20; 8]);
           ...
           elseif select_force_feedforward == force_feedforward_use_adaptive_ICL
               [F_ff, mass_est, icl, W_dot] = force_feedforward.feedforward_force_use_adaptive_ICL(iter,ad_ned, uav_a, multirotor,icl,  ex_ned, ev_ned, mass_est_last, dt);
           end
